...
class TripletGraph:
    ...
    def __init__(self, df_train_labeled: pd.DataFrame, df_test_labeled: pd.DataFrame, cfg: Config):
        ...
        # банки эмбеддингов
        self.pep_bank = load_bank('/mnt/nfs_protein/gavrilenko/mpt/raw/peptides_data.npz')
        self.tcr_bank = load_bank('/mnt/nfs_protein/gavrilenko/mpt/raw/tcr_data.npz')
        self.mhc_bank = load_bank('/mnt/nfs_protein/gavrilenko/mpt/raw/mhc_data.npz')
